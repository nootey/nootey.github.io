<template>
    <Smoothie
        ...
        style="padding-top: 100px; border-top-left-radius: 20px; border-top-right-radius: 20px"
    >
        <div id="outer" class="d-flex flex-row w-100 align-items-center justify-content-center gap-1">
            <div id="col-text" class="d-flex flex-column w-50 gap-5 p-3">
                <animated-component>
                ...
                <div class="paragraph-text">
                    I’m a backend developer with a strong foundation in computer science and a passion for building
                    smart, scalable digital solutions. In my current role, I focus on developing and maintaining robust
                    backend systems that power websites and web applications. I'm always exploring new technologies and
                    constantly learning to stay ahead in the fast-moving tech world.
                </div>

                <div id="button-row" class="d-flex flex-row w-100 align-items-center gap-4">
                    <div id="button" class="d-flex flex-column w-25">
                        <a href="#projects">
            ...
            <div id="image-col" class="d-flex flex-column w-50 justify-content-center align-items-center">
                <svg
                ...
                >
                    ...
                    />
                    <path
                        id="uuid-52db3307-ec3e-496d-a5d4-9d1f33ffc652-45-45-44-44-627"
                    ...
                    />
                    <path
                        id="uuid-2800d917-a06e-4fc6-b661-0f9df9cadefc-46-46-45-45-628"
